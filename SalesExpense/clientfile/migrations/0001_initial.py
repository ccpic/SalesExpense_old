# Generated by Django 2.2 on 2020-03-27 11:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(auto_now=True, verbose_name='上传日期')),
            ],
            options={
                'verbose_name': '客户档案',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.CharField(blank=True, max_length=100, null=True, verbose_name='备注')),
                ('pub_date', models.DateTimeField(auto_now=True, verbose_name='创建日期')),
                ('clients', models.ManyToManyField(to='clientfile.Client')),
